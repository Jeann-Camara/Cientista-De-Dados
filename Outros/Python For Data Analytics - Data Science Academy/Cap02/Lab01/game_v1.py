...
# Escreve mensagem inicial do game.
level = int(input("Qual nível você gostaria de jogar? 1/2/3/4/5 \n"))
length = 500/level

# Configura layout da tela inicial.
root = Tk()
...
# Mostra contagem do score obtido.
def score():
...
# Configura layout dos objetos do game.
