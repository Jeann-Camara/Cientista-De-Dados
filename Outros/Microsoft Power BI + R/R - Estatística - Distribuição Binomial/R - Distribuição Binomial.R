...
# Pasta de trabalho
setwd("C:/Users/d001110/Desktop/R - Estatística - Distribuição Binomial")
getwd()
...
# Caso se queira visualizar as probabilidades para 0, 1, 2 e 3...n = 12 questões, podemos fazer assim:
